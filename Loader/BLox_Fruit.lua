...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		  	if _G.Settings.Auto_Farm_Level or _G.Settings.Auto_Farm_Material or Noclip or _G.Settings.Auto_IsLand or _G.Settings.Auto_Raid or _G.Settings.Auto_Farm_Ectoplasm or _G.Settings.Auto_Factory_Farm or _G.Settings.Auto_Elite_Hunter or _G.Settings.Auto_Holy_Torch or _G.Settings.Auto_Farm_Bones or _G.Settings.Auto_Farm_Observation or _G.Settings.Auto_Soul_Guitar or _G.Settings.Auto_Farm_Mastery_DF or _G.Settings.Auto_Farm_Mastery_Gun then
...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
			if _G.Settings.Auto_Farm_Level or _G.Settings.Auto_Farm_Material or _G.Settings.Auto_IsLand or _G.Settings.Auto_Raid or Noclip or _G.Settings.Auto_Farm_Ectoplasm or _G.Settings.Auto_Factory_Farm or _G.Settings.Auto_Elite_Hunter or _G.Settings.Auto_Holy_Torch or _G.Settings.Auto_Farm_Bones or _G.Settings.Auto_Farm_Observation or _G.Settings.Auto_Soul_Guitar or _G.Settings.Auto_Farm_Mastery_DF or _G.Settings.Auto_Farm_Mastery_Gun then
...
local PepsiUi=library:CreateWindow({Name="EDOG HUB PREMIUM SCRIPTS",Themeable={Info="Discord Server: discord.gg/xenonhub"}});
local Genaral = PepsiUi:CreateTab({Name = "Genaral"})
local ISLAND = PepsiUi:CreateTab({Name = "Visuals"})
...
local Dungeon =  ISLAND:CreateSection({Name = [[\\ Dungeon //]],Side = "Left"})
local Players =  ISLAND:CreateSection({Name = [[\\ Players //]],Side = "Left"})
local Teleport =  ISLAND:CreateSection({Name = [[\\ Teleport To IsLand //]],Side = "Right"})
local Aimbot =  ISLAND:CreateSection({Name = [[\\ Aimbot //]],Side = "Right"})
A:AddToggle({
        ...
        pcall(function() 
            if _G.Settings.Auto_Farm_Level then 
                ...
                if DOINGQUEST() == false then 
                    ...
                    Fast_Attack=false 
                    if game.Players.LocalPlayer:DistanceFromCharacter(CFrameQuest.Position)>=1500 then 
                        Bypass(CFrameQuest) 
                    end 
...
coroutine.wrap(function() 
    while wait(.01) do 
        if _G.Settings.Fast_Attack then 
            if Fast_Attack then
                pcall(function() 
                    AttackFunction() 
                    if cooldownfastattack - tick() > .9 then 
						wait(0.175)
	...
	pcall(function()
		if _G.Settings.Auto_Farm_Bones and not raidiing and World3 then
			...
			if (heuantedcalstle.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1500 then
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = heuantedcalstle
				wait(0.1)
...
Dungeon:AddDropDown({
	...
	Callback = function(v)
		_G.Settings.Selected_Raids = v
		s()
	end
})
Dungeon:AddToggle({
	Name = "Auto Dungeon",
	Value = _G.Settings.Auto_Raid,
	Callback = function(v)
		_G.Settings.Auto_Raid = v
		s()
	end
})
Dungeon:AddToggle({
	Name = "Auto Kill Aura",
	Value = _G.Settings.Auto_KillAura,
	Callback = function(v)
		_G.Settings.Auto_KillAura = v
		s()
	end
})
Dungeon:AddToggle({
	Name = "Auto Next IsLand",
	Value = _G.Settings.Auto_IsLand,
	Callback = function(v)
		_G.Settings.Auto_IsLand = v
		s()
	end
})
Dungeon:AddToggle({
	Name = "Auto Awakened",
	Value = _G.Settings.Auto_Awakened,
	Callback = function(v)
		_G.Settings.Auto_Awakened = v
		s()
	end
})
task.spawn(function()
	while wait() do
		if _G.Settings.Auto_Raid and not _G.Settings.Auto_Farm_Level  then 
			if game.Players.LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game.Players.LocalPlayer.Character:FindFirstChild("Special Microchip") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") or game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
						...
						repeat wait()
							...
							elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
								...
								if (game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 350 then
									totarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame)
							...
							elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
								...
								if (game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 350 then
									totarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4").CFrame)
							...
							elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") then
								...
								if (game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 350 then
									totarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3").CFrame)
							...
							elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
								...
								if (game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 350 then
									totarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame)
							...
							elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
								...
								if (game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 350 then
									totarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1").CFrame)
							...
							for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
								if _G.Settings.Auto_Raid and game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == true and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 400 then
									repeat wait()
										v.Humanoid.Health = 0
										v:BreakJoints()
									until not _G.Settings.Auto_Raid or v.Humanoid.Health <= 0 or not v.Parent
								end
							end
				...
				local args = {
					[1] = "RaidsNpc",
					[2] = "Select",
					[3] = tostring(_G.Settings.Selected_Raids)
				}
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
			end
		end
...
spawn(function()
	while wait() do
		if _G.Settings.Auto_IsLand then
			for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
				if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
					pcall(function()
						...
						until not _G.Settings.Auto_KillAura or not RaidSuperhuman or not v.Parent or v.Humanoid.Health <= 0
					end)
				end
			end
		end
...
for i,v in pairs(game:GetService("Players"):GetChildren()) do
	table.insert(Players_,v.Name)
end
_G.Select_Players = "Select Players"
Players:AddDropdown({
	Name = "Select Players",
	Value = _G.Select_Players,
	List = Players_,
	Callback = function(v)
		_G.Select_Players = v
	end
...
Players:AddToggle({
	...
	Callback = function(v)
		_G.Teleportp=v
		if _G.Teleportp and not raidiing then
			repeat wait()
				Noclip = true
				totarget(game.Players[_G.Select_Players].Character.HumanoidRootPart.CFrame)
			until not _G.Teleportp
			Noclip = false
		end
	end
})
