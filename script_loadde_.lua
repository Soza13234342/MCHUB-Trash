...
local Status = PepsiUi:CreateTab({Name = "Status"})
local M = Status:CreateSection({Name = [[\\ Main //]],Side = "Left"})
local S = Status:CreateSection({Name = [[\\ Status //]],Side = "Left"})
local F = Status:CreateSection({Name = [[\\ Fighting Style //]],Side = "Left"})
local Q = Status:CreateSection({Name = [[\\ Check Quest //]],Side = "Left"})
local A = Status:CreateSection({Name = [[\\ Sword //]],Side = "Right"})
local b = Status:CreateSection({Name = [[\\ Legendary Sword //]],Side = "Right"})
local G = Status:CreateSection({Name = [[\\ Gun //]],Side = "Right"})
...
Auto_Farm_S = M:AddLabel("Status : nil")
...
function Auto_Farm()
	pcall(function()
		if _G.Auto_Farm and not Auto_Raid then
			local MyLevel = game.Players.LocalPlayer.Data.Level.Value
			if MyLevel >= 200 and Check_Weapon("Saber") == "Not Have" then
				...
				BypassTp = true
			elseif MyLevel >= 700 and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("DressrosaQuestProgress", "Dressrosa") ~= 0 and Check_Weapon("Saber") == "Have" then 
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress").UsedKey == true then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress").TalkedDetective == true then
						if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress").KilledIceBoss == true then
							...
							if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral [Lv. 700] [Boss]") then
								...
								until not _G.Auto_Farm or x:DistanceFromCharacter(CFrame.new(1347.7124, 37.3751602, -1325.6488).Position) <= 10
							end
						end
					else
					...
					elseif game.Players.LocalPlayer.Character:FindFirstChild("Key") then
						repeat wait()
							toTarget(CFrame.new(1347.7124,37.3751602,-1325.6488))
						until x:DistanceFromCharacter(Vector3.new(1347.7124,37.3751602,-1325.6488)) <=10 or not _G.Auto_Farm
					else
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective")
					end
				end
			...
			elseif World2 and game.Players.LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") or game.Players.LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
				Auto_Farm_S:Set("Status : Spawn Drakbeard")
				repeat wait(.5)
			...
			elseif World2 and (game:GetService("Workspace").Enemies:FindFirstChild("Darkbeard [Lv. 1000] [Raid Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Darkbeard [Lv. 1000] [Raid Boss]")) then
				Auto_Farm_S:Set("Status : Farming Drakbeard")
			...
			elseif World2 and game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") or game.ReplicatedStorage:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
			...
			elseif World3 and game.Workspace.Enemies:FindFirstChild("Captain Elephant [Lv. 1875] [Boss]") or game.ReplicatedStorage:FindFirstChild("Captain Elephant [Lv. 1875] [Boss]") then
				Auto_Farm_S:Set("Status : Finding Twin Hooks")
			...
			elseif World3 and (game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen [Lv. 2175] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Queen [Lv. 2175] [Boss]")) then
				Auto_Farm_S:Set("Status : Finding Buddy")
			...
			elseif World3 and (game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]")) then
				FastAttackSpeed = false
				Auto_Farm_S:Set("Status : Finding Canvander")
			...
			elseif World3 and (game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form [Lv. 5000] [Raid Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form [Lv. 5000] [Raid Boss]")) and Check_Weapon("Tushita") == "Have" and MyLevel >= 2000 then
				Auto_Farm_S:Set("Status : Farming Rip indra")
			...
			elseif World3 and (game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]")) or (game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]")) or (game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]")) then
				Auto_Farm_S:Set("Status : Farming Elite Hunter")
			...
			elseif World3 and GetMaterial("Bones") < 3000 and MyLevel >= 2450 then
				Auto_Farm_S:Set("Status : Farming Bones")
				FastAttackSpeed=false
				Bringmob=false
			...
			elseif World3 and GetMaterial("Bones") >= 3000 and MyLevel >= 2450 and Check_Weapon("Spikey Trident") == "Not Have" then
				Auto_Farm_S:Set("Status : Auto Cake Prince")
				...
				Auto_Farm_S:Set("Status : Farming")
				Auto_Farm_Level()
			end
		end
	end)
