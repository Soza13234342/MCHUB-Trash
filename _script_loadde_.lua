...
task.spawn(function()while wait() do raMon = math.random(1,50)end end)
function CheckQuest()
...
local library = {
	...
	colors = {
		...
		section = Color3.fromRGB(0, 255, 255),
		...
		tabText = Color3.fromRGB(0, 255, 255)
	},
	gui_parent = (function()
...
local PepsiUi=library:CreateWindow({Name="GOOST Edition",Themeable={Info="Discord Server: https://discord.gg/WJZks4TT"}});
...
local function Auto_Farm_Level()
	...
	elseif MyLevel >= 100 and MyLevel <= 300 then
		...
		elseif GetQuest.Visible == true then
			PlayersName = string.split(string.split(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Defeat')[2], ' ')[2]:gsub(' ', '')
			for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
				if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
					if v.Name == PlayersName and tostring(v.Data.Level.Value) >= 20 then
						repeat wait()
						...
						until not _G.Auto_Farm_Players_Quest or _G.Auto_Farm or not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) or v.Humanoid.Health <= 0 or not v.Parent or GetQuest.Visible == false
					end
				end
			end
		end
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.Auto_Farm and v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
						if string.find(GetQuestTitle.Text, NameMon) then
							...
							until not game:GetService("Workspace").Enemies:FindFirstChild(Name) or not _G.Auto_Farm or not string.find(GetQuestTitle.Text, NameMon) or v.Humanoid.Health <= 0 or not v.Parent or GetQuest.Visible == false
							Bringmob = false
							FastAttackSpeed = false			
						else
...
function Auto_Farm()
	pcall(function()
		if _G.Auto_Farm and not Auto_Raid and not _G.BreakAllProcess then
			local MyLevel = game.Players.LocalPlayer.Data.Level.Value
			if MyLevel >= 200 and Check_Weapon("Saber") == "Not Have" then
				BypassTp = false
				...
				BypassTp = true
			--elseif World1 and MyLevel >= 700 and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("DressrosaQuestProgress", "Dressrosa") ~= 0 and Check_Weapon("Saber") == "Have" then 
			...
			elseif World2 and I_HAVE_FRUIT_1M == true and MyLevel >= 1000 then
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then
			...
			elseif World2 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil and game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") or game.ReplicatedStorage:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
				if game:GetService("Workspace").Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
					...
					until (CFrame.new(2284.912109375, 15.537666320801, 905.48291015625).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 or not _G.Auto_Farm
				end
			elseif World2 and game.Workspace.Enemies:FindFirstChild("Fajita [Lv. 925] [Boss]") or game.ReplicatedStorage:FindFirstChild("Fajita [Lv. 925] [Boss]") then
				if game:GetService("Workspace").Enemies:FindFirstChild("Fajita [Lv. 925] [Boss]") then
					...
					repeat wait()
						toTarget(CFrame.new(-2138.48804, 72.1689606, -4326.45508, -0.956310987, 6.75805367e-08, 0.292351395, 6.95096816e-08, 1, -3.7888066e-09, -0.292351395, 1.66979746e-08, -0.956310987))
					until (CFrame.new(-2138.48804, 72.1689606, -4326.45508, -0.956310987, 6.75805367e-08, 0.292351395, 6.95096816e-08, 1, -3.7888066e-09, -0.292351395, 1.66979746e-08, -0.956310987).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 or not _G.Auto_Farm
				end
